...
namespace Hag.Renderer
{
    public class Direct2DRenderer : IDisposable
    {
        ...
        private void setupInstance(Direct2DRendererOptions options)
        {
            ...
            device.TextAntialiasMode = options.AntiAliasing ? SharpDX.Direct2D1.TextAntialiasMode.Grayscale : SharpDX.Direct2D1.TextAntialiasMode.Grayscale;
        ...
        public void EndScene()
        {
            ...
            if (MeasureFPS && stopwatch.IsRunning)
            {
                ...
                int sleepTimePerFrame = 1000 / 144;

                int remainingTime = (int)(sleepTimePerFrame - (endTime - stopwatch.ElapsedMilliseconds));
        ...
        /// </summary>
        /// <param name="milliseconds"></param>
        public void Loop(int milliseconds)
        {
            var watch = stopwatch;
        ...
        public void DrawRoundedRectangle(float x, float y, float width, float height, float aa, float stroke, Direct2DBrush brush)
        {
            ...
            device.DrawRoundedRectangle(rect, brush, stroke);
        }

        public void DrawRoundedRectangle(float x, float y, float width, float height, float aa, float stroke, Direct2DColor color)
        {
            var rect = new SharpDX.Direct2D1.RoundedRectangle()
            {
                RadiusX = aa,
            ...
            sharedBrush.Color = color;
            device.DrawRoundedRectangle(rect, sharedBrush, stroke);
        }
        ...
        public void FillRoundedRectangle(float x, float y, float width, float height, float aa, Direct2DBrush brush)
        {
            var rect = new SharpDX.Direct2D1.RoundedRectangle()
            {
                RadiusX = aa,
            ...
            device.FillRoundedRectangle(rect, brush);

        }

        public void FillRoundedRectangle(float x, float y, float width, float height, float aa, Direct2DColor color)
        {
            var rect = new SharpDX.Direct2D1.RoundedRectangle()
            {
                RadiusX = aa,
            ...
            sharedBrush.Color = color;
            device.FillRoundedRectangle(rect, sharedBrush);
        }
        ...
        {
            sharedBrush.Color = new RawColor4(0, 0, 0, 255);
            sharedBrush.Color = color;
        ...
        {
            sharedBrush.Color = new Direct2DColor(0, 0, 0, 255);
            sharedBrush.Color = brush;
        ...
        public void DrawTextCentered(string text, float x, float y, Direct2DFont font, Direct2DColor color)
        {
            var layout = new TextLayout(fontFactory, text, font, float.MaxValue, float.MaxValue);
            ...
            sharedBrush.Color = color;
            device.DrawTextLayout(new RawVector2(x - (layout.Metrics.Width + modifier) / 2, y), layout, sharedBrush, DrawTextOptions.NoSnap);

            layout.Dispose();
        }
        public void DrawTextCentered(string text, float x, float y, float fontSize, Direct2DFont font, Direct2DColor color)
        {
            var layout = new TextLayout(fontFactory, text, font, float.MaxValue, float.MaxValue);
            layout.SetFontSize(fontSize, new TextRange(0, text.Length));
        ...
        public void DrawTextCentered(string text, float x, float y, Direct2DFont font, Direct2DBrush brush)
        {
            var layout = new TextLayout(fontFactory, text, font, float.MaxValue, float.MaxValue);
            ...
            device.DrawTextLayout(new RawVector2(x - (layout.Metrics.Width + modifier) / 2, y), layout, brush, DrawTextOptions.NoSnap);
